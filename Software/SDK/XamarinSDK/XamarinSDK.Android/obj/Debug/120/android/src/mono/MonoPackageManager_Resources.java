...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinSDK.Android.dll" comes first in this list. */
		"XamarinSDK.Android.dll",
		"FormsViewGroup.dll",
		"StarIoWrapper.dll",
		"StarIO_ClassLibrary.Android.dll",
		"StarIO_Extension_ClassLibrary.Android.dll",
